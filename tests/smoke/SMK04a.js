...
module.exports = {
  'Create LOCAL Direct Client CATO Order with Tactical, Buying Area & ABI Discount' : function (browser) {
    browser
      ...
      .page.orderPage().enterOrderName(data.smk04Data.catoOrderDetails.nameLocal)
      .page.orderPage().enterDirectClientDetails(data.smk04Data.orderDetailsLocal)
      .page.orderPage().enterSalesTeam(data.smk04Data.orderDetailsLocal)
