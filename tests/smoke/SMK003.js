...
module.exports = {
  'Create LOCAL Direct Client CATO Order with Tactical & Buying Area Discount' : function (browser) {
    browser
      ...
      //Enter LOCAL order details
      .page.orderPage().enterOrderName(data.smk003Data.catoOrderDetails.nameLocal)
      .page.orderPage().enterDirectClientDetails(data.smk003Data.orderDetailsLocal)
      .page.orderPage().enterSalesTeam(data.smk003Data.orderDetailsLocal)
      .page.orderPage().saveOrderDetails() 

      //Create CATO details for NonRajar Buying Area
      .page.orderPage().createNewAirtimeOption()
      //.page.catoPage().calculateStartDateFromNextDay(data.smk003Data.localCatoDetails.startIn)
      .page.catoPage().calculateAndSelectStartDate(data.smk003Data.localCatoDetails.startIn)
      .page.catoPage().calculateAndSelectEndDate(data.smk003Data.localCatoDetails.duration)
      //.page.catoPage().addDefaultProductsAndSpotlength()
      .page.catoPage().addProductAndSpotlengthTopAndTail(data.smk003Data.localCatoDetails.product1)
      .page.catoPage().addSingleNonRajar()

      //Set discounts and save
      .page.catoPage().configureBuyingAreaDiscounts(data.smk003Data.localCatoDetails.baDiscount)
      .page.catoPage().configureTacticalDiscounts(data.smk003Data.localCatoDetails.tacticalDiscount)
      ...
      //Get pre & post discount values for each spot
